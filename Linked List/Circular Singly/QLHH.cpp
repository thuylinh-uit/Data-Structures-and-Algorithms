/* Viet chuong trinh thuc hien cac yeu cau sau tren danh sach lien ket don vong:
	a. Khai bao CTDL hang hoa, biet thong tin mot mat hang bao gom
		- Ma so
		- Ten
		- So luong
	b. Nhap thong tin cac mat hang
	c. Sap xep cac mat hang theo so luong tang dan
*/
#include <iostream>
#include <string>
using namespace std;
